...
public class Indexer extends SubsystemBase {
    ...
    private static final LoggedTunable<Voltage> stageVoltage = LoggedTunable.from("Rollers/Indexer/Stage Volts", Volts::of, 2.0);
    private static final LoggedTunable<Voltage> kickVoltage = LoggedTunable.from("Rollers/Indexer/Kick Volts", Volts::of, 2.0);
