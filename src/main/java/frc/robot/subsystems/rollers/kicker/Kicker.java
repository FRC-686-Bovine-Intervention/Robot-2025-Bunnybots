...
public class Kicker extends SubsystemBase {
    ...
    private static final LoggedTunable<Voltage> stageVoltage = LoggedTunable.from("Rollers/Kicker/Stage Volts", Volts::of, 2.0);
    private static final LoggedTunable<Voltage> kickVoltage = LoggedTunable.from("Rollers/Kicker/Kick Volts", Volts::of, 2.0);
